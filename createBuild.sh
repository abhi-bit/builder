...
createbuild()
{
    ...
    ssh -p $port couchbase@localhost "cd /home/couchbase/builder; repo sync --jobs=20; cbbuild/scripts/jenkins/couchbase_server/server-linux-build.sh $OS 1010.0.0 enterprise 1"
